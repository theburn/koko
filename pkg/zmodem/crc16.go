...
// copy from https://github.com/stellar/go/raw/3eb7027b9795adb52c086242e7a65adfd5d478b9/crc16/main.go
...
func (c CRC16) Checksum(data []byte) []byte {
	var crc uint16
...
func (c CRC16) CRC16Validate(data []byte, expected []byte) error {
